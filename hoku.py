...
def nextWord(length, arr):
    '''
       возвращает слово с заданным колл-вом слогов
       
       length - "длинна" cслова в слогах
...
def nextLine(length, arr):
    '''
       возвращает строку с заданным колл-вом слогов
...
name = input('Введите имя файла без расшерения (\'in\' по умолчанию) :')
